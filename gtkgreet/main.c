...
// Checks for layer shell access in wayland
...
static GOptionEntry entries[] = {
    ...
    {"command", 'c', 0, G_OPTION_ARG_STRING, &command, "Command to run",
     "sway"},
    {"background", 'b', 0, G_OPTION_ARG_STRING, &background,
     "Background image to use", NULL},
...
int main(int argc, char **argv) {
  ...
  GOptionContext *option_context =
      g_option_context_new("- GTK-based greeter for greetd");
